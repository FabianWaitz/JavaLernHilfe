...
<sql:update dataSource="jdbc/nutzer">
    ...
    ('Klasse', 'Die Klassen sind die Basis in JAVA. Jede Klasse ist ein Objekttyp z.B. eine Farbe. Alles was ich in JAVA verwenden möchte, muss in irgendwelchen Klassen stehen.', 'false'),
